...
// Hämtar och parsear från skanelabs api, appendar sedan till buss listans ArrayList 
// Inspiration och hjälp hämtat från Marcus Johanssons Github

public class SkaneApi {
	
	//ArrayList av alla objekt
	private ArrayList<SkaneBusStop> busList = new ArrayList<SkaneBusStop>();
	
	// metod som returnerar objekt
    ...
    // returnerar objektets namn, id, x-koordinater, avstånd samt adress
